// src/components/features/ServiceTitleSubtitle/component/ServiceModal.tsx
...
interface ServiceModalProps {
  ...
  readonly onSave: (data: CreateServiceTitleDTO) => void;
  readonly initialData?: ServiceTitle | null;
}
...
export default function ServiceModal({
  ...
  const [formData, setFormData] = useState<CreateServiceTitleDTO>({
      ...
      <DialogContent className="sm:max-w-[500px] p-0 border-none shadow-2xl">
        <DialogHeader className="px-8 py-6 border-b bg-white z-10">
          <DialogTitle className="text-2xl font-bold text-[#1E293B]">
            {initialData ? "Edit Service Title" : "Add Service Title"}
          </DialogTitle>
        </DialogHeader>
