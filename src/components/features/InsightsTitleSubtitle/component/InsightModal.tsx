// src/components/features/InsightsTitleSubtitle/component/InsightModal.tsx
...
interface InsightModalProps {
  ...
  readonly onSave: (data: CreateInsightDTO) => void;
  readonly initialData?: Insight | null;
}
...
export default function InsightModal({
  ...
  const [formData, setFormData] = useState<CreateInsightDTO>({
      ...
      <DialogContent className="sm:max-w-[500px] p-0 border-none shadow-2xl">
        <DialogHeader className="px-8 py-6 border-b bg-white z-10">
          <DialogTitle className="text-2xl font-bold text-[#1E293B]">
            {initialData ? "Edit Insight" : "Add Insight"}
          </DialogTitle>
        </DialogHeader>
