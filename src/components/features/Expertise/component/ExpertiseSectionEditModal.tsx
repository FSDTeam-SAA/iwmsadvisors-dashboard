...
import { useUpdateIwmsSolutionsSection } from "../../iwmsSolutionsSection/hooks/useIwmsSolutionsSection";
import { IwmsSolutionsSection } from "../../iwmsSolutionsSection/types/iwmsSolutionsSection.type";
import { X, Upload } from "lucide-react";
import Image from "next/image";
import { isAxiosError } from "axios";

interface ExpertiseSectionEditModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export default function ExpertiseSectionEditModal({
  isOpen,
  onClose,
  iwmsSolutionsSection,
}: ExpertiseSectionEditModalProps) {
  ...
  const [order, setOrder] = useState(iwmsSolutionsSection?.order || 4);
      ...
      },
      {
        ...
        onError: (error) => {
          const errorMessage =
            ...
            "Failed to update expertise section";
