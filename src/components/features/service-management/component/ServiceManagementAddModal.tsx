...
export default function ServiceManagementAddModal({
  isOpen,
  onClose,
  onSave,
}: ServiceManagementAddModalProps) {
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              required
              className="w-full"
              placeholder="Enter service page heading"
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              placeholder="Enter expert IWMS guidance text"
            />
          </div>
