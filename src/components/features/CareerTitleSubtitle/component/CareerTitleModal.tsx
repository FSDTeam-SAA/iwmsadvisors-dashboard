// src/components/features/CareerTitleSubtitle/component/CareerTitleModal.tsx
...
interface CareerTitleModalProps {
  readonly isOpen: boolean;
  readonly onClose: () => void;
  readonly onSave: (data: CreateCareerTitleDTO) => void;
  readonly initialData?: CareerTitle | null;
}

export default function CareerTitleModal({
  isOpen,
  onClose,
  onSave,
  initialData,
}: CareerTitleModalProps) {
  const [formData, setFormData] = useState<CreateCareerTitleDTO>({
      ...
      <DialogContent className="sm:max-w-[500px] p-0 border-none shadow-2xl">
        <DialogHeader className="px-8 py-6 border-b bg-white z-10">
          <DialogTitle className="text-2xl font-bold text-[#1E293B]">
            {initialData ? "Edit Career Title" : "Add Career Title"}
          </DialogTitle>
        </DialogHeader>
